...
public static class CharacterFactory
{
        ...
        string visual, string weapon)
    {
        ...
        {
            case "knight":
                return new Knight(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
            case "rogue":
                return new Rogue(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
            case "wizard":
                return new Wizard(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
            case "orc":
                return new Orc(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
            case "skeleton":
                return new Skeleton(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
            case "ghost":
                return new Ghost(health, speed, damageMin, damageMax, 
                    hitChance, blockChance, items, visual, weapon);
        }
